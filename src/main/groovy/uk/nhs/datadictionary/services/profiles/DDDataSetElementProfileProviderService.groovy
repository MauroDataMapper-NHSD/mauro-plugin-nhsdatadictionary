...
@Singleton
@CompileStatic
class DDDataSetElementProfileProviderService extends JsonBasedProfile {

    DDDataSetElementProfileProviderService(ObjectMapper objectMapper) {
        super(objectMapper)
    }

    @Override
    String getJsonFileName() {
        return 'profiles/dataSetElementProfile.json'
    }
