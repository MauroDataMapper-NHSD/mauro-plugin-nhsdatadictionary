...
@Slf4j
class DDDataSetProfileProviderService extends JsonBasedProfile {

    DDDataSetProfileProviderService(ObjectMapper objectMapper) {
        super(objectMapper)
    }

    @Override
    String getJsonFileName() {
        return 'profiles/dataSetProfile.json'
    }
