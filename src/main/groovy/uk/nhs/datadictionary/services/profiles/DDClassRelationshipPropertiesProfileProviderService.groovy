...
class DDClassRelationshipPropertiesProfileProviderService extends JsonBasedProfile{

    DDClassRelationshipPropertiesProfileProviderService(ObjectMapper objectMapper) {
        super(objectMapper)
    }
