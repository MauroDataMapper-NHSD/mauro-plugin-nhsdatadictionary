...
class DaisyDiffHelperSpec extends Specification {
    ...
    void "should diff SNOMED clinical finding html without assertion failure"() {
        when:
        String leftHtml = "<a href=\"dm:Data_Elements|dc:C|de:CODED_FINDING_(CODED_CLINICAL_ENTRY)\">CODED FINDING (CODED CLINICAL ENTRY)</a> is the same as attribute   <a href=\"dm:Classes_and_Attributes|de:CLINICAL_CLASSIFICATION_CODE\">CLINICAL CLASSIFICATION CODE</a> or   <a href=\"dm:Classes_and_Attributes|de:CLINICAL_TERMINOLOGY_CODE\">CLINICAL TERMINOLOGY CODE</a>.  <p>    <a href=\"dm:Data_Elements|dc:C|de:CODED_FINDING_(CODED_CLINICAL_ENTRY)\">CODED FINDING (CODED CLINICAL ENTRY)</a> is the     <a href=\"dm:Classes_and_Attributes|dc:CODED_CLINICAL_ENTRY\">CODED CLINICAL ENTRY</a> which is used to identify a     <a href=\"te:NHS_Business_Definitions|tm:Clinical_Finding\">Finding</a>.  </p>  <p>For further information on     <a href=\"te:NHS_Business_Definitions|tm:Clinical_Finding\">Findings</a>, see the:  </p>  <ul>    <li>      <div>        <a href=\"te:Supporting_Information|tm:SNOMED_CT\">SNOMED CT</a>® Glossary at:         <a href=\"https://confluence.ihtsdotools.org/\" target=\"_blank\">Clinical Finding and Disorder</a>      </div>    </li>    <li>      <div>        <a href=\"https://nhsengland.kahootz.com/t_c_home/view?objectId=30206597\" target=\"_blank\">SNOMED CT Fact Sheet: Structure of SNOMED CT</a>.      </div>    </li>  </ul>"
        String rightHtml = "<a href=\"dm:Data_Elements|dc:C|de:CODED_FINDING_(CODED_CLINICAL_ENTRY)\">CODED FINDING (CODED CLINICAL ENTRY)</a> is the same as attribute   <a href=\"dm:Classes_and_Attributes|de:CLINICAL_CLASSIFICATION_CODE\">CLINICAL CLASSIFICATION CODE</a> or   <a href=\"dm:Classes_and_Attributes|de:CLINICAL_TERMINOLOGY_CODE\">CLINICAL TERMINOLOGY CODE</a>.  <p>    <a href=\"dm:Data_Elements|dc:C|de:CODED_FINDING_(CODED_CLINICAL_ENTRY)\">CODED FINDING (CODED CLINICAL ENTRY)</a> is the     <a href=\"dm:Classes_and_Attributes|dc:CODED_CLINICAL_ENTRY\">CODED CLINICAL ENTRY</a> which is used to identify a     <a href=\"te:NHS_Business_Definitions|tm:Clinical_Finding\">Finding</a>.  </p>  <p>For further information on     <a href=\"te:NHS_Business_Definitions|tm:Clinical_Finding\">Findings</a>, see the:  </p>  <ul>    <li>      <div>        <a href=\"te:Supporting_Information|tm:SNOMED_CT\">SNOMED CT</a>® Document Library at:         <a href=\"https://docs.snomed.org/\" target=\"_blank\">Clinical Findings with Explicit Context</a>      </div>    </li>    <li>      <div>        <a href=\"https://nhsengland.kahootz.com/t_c_home/view?objectId=30206597\" target=\"_blank\">SNOMED CT Fact Sheet: Structure of SNOMED CT</a>.      </div>    </li>  </ul>"
